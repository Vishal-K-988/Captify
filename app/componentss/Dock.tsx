...
import { CalendarIcon, HomeIcon , File  , UserRound } from "lucide-react"
...
const Icons = {
  ...
  email: (props: IconProps) => <UserRound {...props} />,
...
const DATA = {
  navbar: [
    ...
    { href: "https://captify-neon.vercel.app/documentation", icon: File, label: "Documentation" },
  ],
  contact: {
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/Vishal-K-988/Captify",
        icon: Icons.github,
      },
